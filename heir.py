...
task1 = Task(description='''Build a testemonials page for our website called The AIffice. 
             Make sure it has text inputs for the name, and the review. Include the date and time. 
             Allow users to reply to testemonials.''', expected_output='default output', agent=researcher)
...
task3 = Task(description='''Think about the project that's been proposed. Build out the entire code.''', expected_output='default output', agent=coder)
task4 = Task(description='''Read the code you've been given, is there anything missing from project? Is it working? Can it be styled better? 
             Suggest to the coder improvements they should make. To make suggestions, 
             output the same code and include your suggestions as commented-out code.''', expected_output='default output', agent=designer)
task5 = Task(description='''Iterate on the code to improve the game, based on the designers instructions.''', expected_output='default output',  agent=coder)
...
task7 = Task(description='write a story arc and develop characters.', expected_output='default output', agent=producer)
task8 = Task(description='''write a comedy tv show script surrounding the characters and process of building the app that youve been handed. 
             Make sure there is banter, struggle, arguements, hilarious jokes in the dialogue. 
             Seperate into 5 scenes, each with at least 10 lines.''', expected_output='default output', agent=producer)
